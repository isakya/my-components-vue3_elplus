import { defineComponent, onMounted, ref, resolveComponent, openBlock, createBlock, unref, isRef, withCtx, createElementVNode, toDisplayString, createVNode, normalizeClass, createElementBlock, Fragment, renderList, createTextVNode } from "vue";
var city = {
  "cities": {
    "A": [{
      "id": 56,
      ...
      return openBlock(), createBlock(_component_el_popover, {
        ...
        reference: withCtx(() => [
          createElementVNode("div", {
            onClick: _cache[0] || (_cache[0] = (...args) => unref(hdToggle) && unref(hdToggle)(...args)),
            class: "result"
          }, [
            createElementVNode("div", null, toDisplayString(unref(result)), 1),
            createElementVNode("div", null, [
              createVNode(_component_el_icon_arrowdown, {
                class: normalizeClass({ "rolate": unref(visible) })
              }, null, 8, ["class"])
            ])
          ])
        ]),
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6fa62f7a"]]);
var index = {
  install(app) {
