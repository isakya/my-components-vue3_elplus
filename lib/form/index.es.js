            ...
            return openBlock(), createElementBlock(Fragment, { key: index2 }, [
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  ...
                  }, item.attrs), null, 16, ["modelValue", "onUpdate:modelValue", "placeholder"])) : createCommentVNode("", true),
                  item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({
                    key: 1,
                    ...
                    _: 2
                  }, 1040, ["on-preview", "on-remove", "on-success", "on-error", "on-progress", "on-change", "before-remove", "before-upload", "http-request", "on-exceed"])) : createCommentVNode("", true),
...
var index = {
  install(app) {
    app.component("my-form", _sfc_main);
  }
};
