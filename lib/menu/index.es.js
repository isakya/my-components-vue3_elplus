import { defineComponent, resolveComponent, openBlock, createBlock, withCtx, createVNode, mergeProps, createElementBlock, Fragment, renderList, resolveDynamicComponent, unref, createCommentVNode, createElementVNode, toDisplayString, createStaticVNode, isVNode, useAttrs } from "vue";
const toLine = (value) => {
...
var menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5801aa97"]]);
  ...
  setup(props, ctx) {
    let renderMenu = (data) => {
      ...
      return data.map((item) => {
        ...
        return createVNode(resolveComponent("el-menu-item"), mergeProps({
          "index": item[props.index]
        }, attrs), {
    ...
    return () => {
      ...
      return createVNode(resolveComponent("el-menu"), {
        ...
        "router": props.router
      }, _isSlot(_slot = renderMenu(props.data)) ? _slot : {
        default: () => [_slot]
      });
    };
  }
